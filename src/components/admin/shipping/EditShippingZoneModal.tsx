...
interface EditShippingZoneModalProps {
  ...
  onEditZone: (zoneId: string, updates: { name: string; regions: string[] }) => void;
}

export function EditShippingZoneModal({ isOpen, onOpenChange, zone, onEditZone }: EditShippingZoneModalProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (!zoneName.trim() || !regions.trim() || !zone) {
      toast({
        title: "Error",
